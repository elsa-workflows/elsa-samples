...
using ElsaServerAndStudioComponentsInOne.Client.Services;
using Microsoft.Extensions.DependencyInjection.Extensions;

namespace ElsaServerAndStudioComponentsInOne.Client;

public class ElsaStudioBootstrapper(IConfiguration configuration, IServiceCollection services)
{
